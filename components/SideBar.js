      ...
      <div className="trm-main-card-frame trm-sidebar">
        ...
        >
          ...
          <div className="trm-mc-header">
            ...
            <h5 className="trm-name trm-mb-15">Tommys Home</h5>
          ...
          <ul className="trm-table trm-mb-20">
            ...
            <li>
              ...
              <div className="trm-label trm-label-light">South Africa</div>
            </li>
            {/* city */}
            <li>
              <div className="trm-label">City:</div>
              <div className="trm-label trm-label-light">Western Cape</div>
            </li>
            {/* age */}
            <li>
              <div className="trm-label">Services:</div>
              <div className="trm-label trm-label-light">Plumbing, Gyser Intallations, Solar Installations, Electrical Repairs, General Repairs</div>
            </li>
          </ul>
          {/* info end */}
          <div className="trm-divider trm-mb-40 trm-mt-40" />
