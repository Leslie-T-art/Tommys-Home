...
import { tommyshomeUtility } from "@/utility";
import { Fancybox } from "@fancyapps/ui";
import { Fragment, useEffect } from "react";
const tommyshomeLayout = ({ children, noSidebar, onePage }) => {
  useEffect(() => {
    tommyshomeUtility.scrollAnimation();
  }, []);
...
export default tommyshomeLayout;
